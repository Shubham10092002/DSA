...
// Given n dice each with m faces. Find the number of ways to get sum x. 
//which is the summation of values on each face when all the dice are thrown.
// Example:
// Input: m = 6, n = 3, target = 12
// Output: 25
